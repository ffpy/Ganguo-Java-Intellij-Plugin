...
public class RepositoryDirectoryContext {

    /**
     * domain文件夹
     */
    @Var
    public PsiDirectory domainDir(FuncAction<PsiDirectory> createModuleDir) {
     ...
     */
    @Var
    public PsiDirectory infrastructureImplDir(PsiDirectoryFactory directoryFactory, VirtualFile packageFile) {
     ...
     */
    @Var
    public PsiDirectory infrastructureDbImplDir(PsiDirectoryFactory directoryFactory, VirtualFile packageFile) {
